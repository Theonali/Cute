...
clear_sql(){
  mysql -u$dbuser -p$dbpasswd zabbix -e"truncate table history_uint"
  ...
  mysql -u$dbuser -p$dbpasswd zabbix -e"truncate table history"
  ...
  mysql -u$dbuser -p$dbpasswd zabbix -e"truncate table trends_uint"
  ...
  mysql -u$dbuser -p$dbpasswd zabbix -e"truncate table trends"
